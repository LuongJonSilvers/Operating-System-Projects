...
extern unsigned int inodes_per_block;			/* number of inodes per block 8 inodes per block*/
extern unsigned int itable_blocks;				/* size in blocks of the inode table 3rd loop*/
extern unsigned int blocks_per_group;		/* number of blocks per block group */
extern unsigned int num_groups;				/* number of block groups in the image 1st loop iterator group */
